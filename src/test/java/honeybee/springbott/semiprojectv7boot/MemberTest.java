...
//        Member m = new Member(null,"박연진","123456","1234567","박연진","글로리","123-456","서울시 구로구 구로동","더조은","abc123@naver.com","123-456-1234",null);
...
//        Member m = new Member(2L,"문동은","123456","1234567","박연진","글로리","123-456","서울시 구로구 구로동","더조은","abc123@naver.com","123-456-1234",null);
...
// findByUseridAndPasswd 이거 countByUseridAndPasswd로 바뀜
    ...
    public void loginMember() {
        ...
        assertNull(memberRepository.countByUseridAndPasswd(
                m.getUserid(), m.getPasswd()) );

        m.setUserid("abc123");
        m.setPasswd("987xyz");

        assertNotNull(memberRepository.countByUseridAndPasswd(
                m.getUserid(), m.getPasswd()) );
    }
